...
${OBJECTDIR}/Mayor_de_3_numeros.o: Mayor_de_3_numeros.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Mayor_de_3_numeros.o Mayor_de_3_numeros.c

${OBJECTDIR}/Mayor_de_4_numeros.o: Mayor_de_4_numeros.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Mayor_de_4_numeros.o Mayor_de_4_numeros.c

${OBJECTDIR}/Procedencia_de_operadores.o: Procedencia_de_operadores.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Procedencia_de_operadores.o Procedencia_de_operadores.c
...
${OBJECTDIR}/tablas_while_anidado.o: tablas_while_anidado.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tablas_while_anidado.o tablas_while_anidado.c
